...
class SherlockModel:
    ...
    def fit(
        ...
        char_model_input, char_model = self._build_char_submodel(X_train_char.shape[1]) #960
        word_model_input, word_model = self._build_word_submodel(X_train_word.shape[1]) #201
    ...
    def to_json2(self):
        ...
        model_filename = os.path.join(
                    self.model_files_directory, f"{model_id}_model.h5"
                )
